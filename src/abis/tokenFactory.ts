export const tokenFactoryAbi = [
  {
    ...
    inputs: [
      ...
      { name: "reserveWeight", type: "uint32", internalType: "uint32" },
      { name: "slope", type: "uint256", internalType: "uint256" },
      { name: "creator", type: "address", internalType: "address" },
      { name: "reserveTokenAddress", type: "address", internalType: "address" },
      { name: "_exchangeAddress", type: "address", internalType: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [{ name: "batch", type: "address[]", internalType: "address[]" }],
    stateMutability: "view",
  },
  {
    type: "function",
    name: "initialize",
    inputs: [{ name: "_defaultReserveToken", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
